...
class PlayListAdapter(val context: Context, val playListFragment: PlayListFragment, val musicList: MutableList<Music>?, val vibrator: Vibrator) : RecyclerView.Adapter<PlayListAdapter.CustomViewHolder>() {
    companion object {
